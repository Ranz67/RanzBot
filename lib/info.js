exports.info = (id, RANZBOT, corohelp, tampilTanggal, tampilWaktu, instagram, telegram, youtube, kapanbotaktif, grupch1, grupch2) => {
	return `🐼 ${RANZBOT} 🐼
...
INFO BOT! :
🔱 *AUTHOR*: RANZ
🔱 *GITHUB*: https://github.com/Ranz67/RanzBot
🔱 *INSTAGRAM*: ${instagram}
🔱 *YOUTUBE*: ${youtube}
🔱 *TELEGRAM* : ${telegram}
🔱 *WHATSAPP* : 085865230662
